...
public abstract class TicketExpiredGetTask extends AsyncTask<Void, Void, Boolean> {
    ...
    public TicketExpiredGetTask(String token, int userId) {
        this.userId = userId;
        this.token = token;
    }
    ...
    protected Boolean doInBackground(Void... params) {
        ...
        String res = ticketController.getExpiredUserTickets(token, userId);
